...
def test_judge_page_is_a_checkout_to_signed_receipt_story():
    ...
    # The clean and unresolved cases are still reachable, but as secondary
    # controls beside the lead case rather than three buttons of equal weight.
    assert "A clean checkout" in page
    assert "Unresolved evidence" in page
